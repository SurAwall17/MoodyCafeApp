<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <h1 class="mb-3 mt-2 text-center font-semibold text-xl">Create an account</h1>
        ...
        <div class="flex items-center justify-center mt-4">
            ...
            <a class="ms-1 underline text-sm hover:text-gray-900 rounded-md focus:outline-none text-primary"
                href="{{ route('login') }}">
                {{ __('Login') }}
            </a>
